# CDKTF Go bindings for hashicorp/archive provider version 2.6.0

This repo builds and publishes the [Terraform archive provider](https://registry.terraform.io/providers/hashicorp/archive/2.6.0/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
* [Terraform archive provider](https://registry.terraform.io/providers/hashicorp/archive/2.6.0)
