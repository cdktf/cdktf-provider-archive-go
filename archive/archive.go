...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-archive.ArchiveProviderConfig",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-archive.DataArchiveFileConfig",
		reflect.TypeOf((*DataArchiveFileConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-archive.DataArchiveFileSource",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-archive.FileConfig",
		reflect.TypeOf((*FileConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-archive.FileSource",
